...
// Create two new variables — scoreDolphins and scoreKoalas, and
//  assign the value returned from the calcAverage function to them 
...
console.log("avg score dolphins: " , scoreDolphins);

let scoreKoalas = calcAverage(65,54,49);
console.log("avg score kolas: ", scoreKoalas);

let checkWinner = (avgDolphins,avgKolas)=>{
